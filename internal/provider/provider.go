...
import (
	...
	gcpavtddatasources "github.com/trend-vcs/terraform-provider-vision-one/internal/trendmicro/avtd/gcp/data-sources"
	gcpavtdresources "github.com/trend-vcs/terraform-provider-vision-one/internal/trendmicro/avtd/gcp/resources"
	awscamdatasources "github.com/trend-vcs/terraform-provider-vision-one/internal/trendmicro/cloud_account_management/aws/data-sources"
	awsresources "github.com/trend-vcs/terraform-provider-vision-one/internal/trendmicro/cloud_account_management/aws/resources"
	azurecamdatasources "github.com/trend-vcs/terraform-provider-vision-one/internal/trendmicro/cloud_account_management/azure/data-sources"
	azureresources "github.com/trend-vcs/terraform-provider-vision-one/internal/trendmicro/cloud_account_management/azure/resources"
	gcpcamdatasources "github.com/trend-vcs/terraform-provider-vision-one/internal/trendmicro/cloud_account_management/gcp/data-sources"
	gcpresources "github.com/trend-vcs/terraform-provider-vision-one/internal/trendmicro/cloud_account_management/gcp/resources"
	azureclmresources "github.com/trend-vcs/terraform-provider-vision-one/internal/trendmicro/cloud_log_monitoring/azure/resources"
	crmdatasources "github.com/trend-vcs/terraform-provider-vision-one/internal/trendmicro/cloud_risk_management/data-sources"
	crmresources "github.com/trend-vcs/terraform-provider-vision-one/internal/trendmicro/cloud_risk_management/resources"
	"github.com/trend-vcs/terraform-provider-vision-one/internal/trendmicro/container_security/resources"
	gcpdspmdatasources "github.com/trend-vcs/terraform-provider-vision-one/internal/trendmicro/data_security_posture_management/gcp/data-sources"
	gcpdspmresources "github.com/trend-vcs/terraform-provider-vision-one/internal/trendmicro/data_security_posture_management/gcp/resources"
...
func (p *TrendMicroProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		crmresources.NewCommunicationConfigurationResource,
		crmresources.NewAccountScanSettingResource,
		gcpresources.NewIAMCustomRole,
		gcpresources.NewGCPScanRole,
		...
		azureclmresources.NewAzureUdcEventHubInfoResource,
	}
}
